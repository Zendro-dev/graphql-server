...
module.exports = class role_to_user extends Sequelize.Model {
   ...
   * @return {object} The requested record as an object with the type role_to_user, or an error object if the validation after reading fails
  ...
  static async countRecords(search) {
    ...
    options["where"] = helper.searchConditionsToSequelize(
      search,
      role_to_user.definition.attributes
    );
  ...
  static bulkAddCsv(context) {
    ...
    return `Bulk import of role_to_user records started. You will be send an email to ${
      helpersAcl.getTokenFromContext(context).email
  ...
  /**
   * base64Encode - Encode  role_to_user to a base 64 String
   *
   * @return {string} The role_to_user object, encoded in a base 64 String
   */
  base64Encode() {
  ...
  /**
   * stripAssociations - Instance method for getting all attributes of role_to_user.
   *
   * @return {object} The attributes of role_to_user in object form
   */
  stripAssociations() {
  ...
  /**
   * externalIdsArray - Get all attributes of role_to_user that are marked as external IDs.
   *
   * @return {Array<String>} An array of all attributes of role_to_user that are marked as external IDs
   */
  ...
  /**
   * externalIdsObject - Get all external IDs of role_to_user.
   *
