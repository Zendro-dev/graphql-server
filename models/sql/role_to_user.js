...
module.exports = class role_to_user extends Sequelize.Model {
    ...
    static bulkAddCsv(context) {
        ...
        return `Bulk import of role_to_user records started. You will be send an email to ${helpersAcl.getTokenFromContext(context).email} informing you about success or errors`;
    }
