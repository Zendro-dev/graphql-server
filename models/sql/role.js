...
module.exports = class role extends Sequelize.Model {
    ...
    static bulkAddCsv(context) {
        ...
        return `Bulk import of role records started. You will be send an email to ${helpersAcl.getTokenFromContext(context).email} informing you about success or errors`;
    }
    ...
    async usersConnectionImpl({
        ...
        let oppRecords = [];
        if (pagination && (pagination.after !== undefined || pagination.before !== undefined)) {
            let oppOptions = helper.buildOppositeSearchSequelize(search, order, pagination, models.user.idAttribute());
